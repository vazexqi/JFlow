...
public class ReverseLinkedListExample {
	public static void main(String[] args) {
		ShapeAnalysisDataflowSolver solver= new ShapeAnalysisDataflowSolver(new ShapeAnalysisFramework(ReverseLinkedListNormalizedCFGFactory.createCFG(), new ShapeAnalysisTransferFunctionProvider()));
		DataflowSolver<FictionalIR<StaticShapeGraph>, StaticShapeGraph> solution= solver.solve();

		FictionalIR<StaticShapeGraph>[] ir= ReverseLinkedListNormalizedCFGFactory.instr;
