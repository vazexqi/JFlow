 ...
 *******************************************************************************/
package edu.illinois.jflow.core.code.flow;
 ...
 * 
 * Note: This analyzer doesn't do a full flow analysis. For example it doesn't do dead code analysis
 * or variable initialization analysis. It analyses the the first access to a variable (read or
 * write) and if all execution paths return a value.
 */
