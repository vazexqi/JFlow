 ...
 * {@link org.eclipse.jdt.internal.corext.refactoring.code.SnippetFinder} and is licensed under
...
class SnippetFinder extends GenericVisitor {
	...
	public static class Match {
		...
		/**
		 * Tests if the whole duplicate is the full body of a method. If so don't replace it since
		 * we would replace a method body with a new method body which doesn't make to much sense.
		 * 
