...
public class IRContentProvider implements IGraphEntityContentProvider {
	...
	public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
		viewer.refresh();
		graph= (Graph<BasicBlock>)newInput;
	}
	...
	public Object[] getConnectedTo(Object entity) {
		Iterator<BasicBlock> succNodes= graph.getSuccNodes((BasicBlock)entity);
		List<Object> nodes= new ArrayList<Object>();
